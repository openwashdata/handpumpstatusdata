...
data_in <- readr::read_csv("data-raw/chiradzulu handpump verification survey.csv")
...
handpumpstatusdata <- data_in

# Export Data ------------------------------------------------------------------
usethis::use_data(handpumpstatusdata, overwrite = TRUE)
fs::dir_create(here::here("inst", "extdata"))
readr::write_csv(handpumpstatusdata,
                 here::here("inst", "extdata", paste0("handpumpstatusdata", ".csv")))
openxlsx::write.xlsx(handpumpstatusdata,
                     here::here("inst", "extdata", paste0("handpumpstatusdata",
                                                          ".xlsx")))
